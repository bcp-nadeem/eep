<div class="content-wrapper">
    ...
    <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light"><a href="<?php echo base_url('Employee'); ?>"><i class="bx bx-left-arrow-alt"></i> Dashboard</a> / Evaluation Page /</span> Employee List</h4>
        ...
        <div class="card">
            <div class="table-responsive text-nowrap">
                ...
                <tbody class="table-border-bottom-0">
                    <?php if($evaluateddata): ?>
                        <?php foreach( $evaluateddata as $data ): ?>
                            ...
                            <?php endif; ?>
                                ...
                                <td>
                                    <div class="avatar3">
                                        ...
                                        <strong><a href="<?php echo base_url('Employee/ReEvaluateForm/'.$data->main_employee_id); ?>"><?php echo $data->employee_first_name; ?> <?php echo $data->employee_last_name; ?>  <i class='bx bx-link' ></i></a></strong>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <?php if(($data->submit_employee_status)==1 && ($data->submit_manager_status)==0): ?>
                                        Self
                                    <?php elseif(($data->submit_employee_status)==1 && ($data->submit_manager_status)==2): ?>
