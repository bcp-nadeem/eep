<div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light"><a href="<?php echo base_url('Employee'); ?>"><i class="bx bx-left-arrow-alt"></i> Dashboard</a></span></h4>
              <div class="row">
                <div class="col-md-12">
                <span class="emp-list-addbtn">
                <a href="<?php echo base_url('Employee/submitByEmployeePerformance'); ?>">
                  <button type="button" class="btn btn-success">Submit Your Performance</button>
                </a>
                </span>
                  <div class="card">
                    <div class="card-body">
  ...
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
          ...
          <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light"><a href="<?php echo base_url('Employee'); ?>"><i class="bx bx-left-arrow-alt"></i> Dashboard</a></span></h4>  </div>
<?php endif ?>
