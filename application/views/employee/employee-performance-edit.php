<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="<?php echo base_url('Employee/showEmpPerformance'); ?>"><i class='bx bx-left-arrow-alt'></i> Performance Details</a> /</span> Edit Performance</h4>
                    <div class="row">
                            <div class="card mb-4">
